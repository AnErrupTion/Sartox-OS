...
namespace SartoxOS
{
    public class Kernel : Sys.Kernel
    {
        ...
        {
            ColorConsole.WriteLine(ConsoleColor.White, "=> Loading virtual FS...");
            ...
            ColorConsole.WriteLine(ConsoleColor.White, "=> Registering Extended ASCII encoding...");
            Encoding.RegisterProvider(CosmosEncodingProvider.Instance);
            Console.InputEncoding = Encoding.GetEncoding(437);
            Console.OutputEncoding = Encoding.GetEncoding(437);

            ColorConsole.WriteLine(ConsoleColor.White, "=> Initializing SSE...");
            Global.CPU.InitSSE();
            ColorConsole.WriteLine(ConsoleColor.White, "=> Initializing Float...");
            Global.CPU.InitFloat();

            ColorConsole.WriteLine(ConsoleColor.White, "=> Creating live account...");
            ...
            {
                ColorConsole.WriteLine(ConsoleColor.White, "=> Loading setup...");
                Setup.Init();
            }

            Console.Clear();
            ColorConsole.WriteLine(ConsoleColor.White, "Welcome to Sartox OS v" + Reference.Version + "!");
        }

        protected override void Run()
        {
            ColorConsole.WriteLine(ConsoleColor.White, "Login to your user account.");
